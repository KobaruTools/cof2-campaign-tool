...
export const prestigePaths1: PrestigePath[] = [
  ...
  },
  {
    ...
    name: 'Voie du familier fantastique',
    type: 'prestige',
    category: 'generic',
    prerequisites:
  ...
  // ----- Voies d'aventurier (p. 137-145) -----
  {
    ...
    name: "Voie de l'archer arcanique",
    type: 'prestige',
    category: 'adventurer',
    prerequisites: '',
    featureIds: [
  ...
  },
  {
    ...
    name: 'Voie du maître des poisons',
    type: 'prestige',
    category: 'adventurer',
    prerequisites: '',
    featureIds: [
...
export const prestigeFeatures1: Feature[] = [
  // ===== Voie de l'expert (p. 129) =====
  {
    id: 'prestige-expert-r4',
    name: 'Capacité de néophyte',
    pathId: 'prestige-expert',
    rank: 4,
    isSpell: false,
    actionTypes: [],
    text:
  ...
  },
  {
    ...
    name: 'Capacité de professionnel',
    pathId: 'prestige-expert',
    rank: 6,
    isSpell: false,
    actionTypes: [],
  ...
  },
  {
    ...
    name: 'Caractéristique fabuleuse',
    pathId: 'prestige-specialiste',
    rank: 6,
    isSpell: false,
    actionTypes: [],
  ...
  // ===== Voie de l'archer arcanique (p. 137) =====
  {
    ...
    name: 'Flèche magique',
    pathId: 'prestige-archer-arcanique',
    rank: 4,
    isSpell: false,
    actionTypes: [],
    text:
  ...
  // ===== Voie des ombres (p. 139) =====
  {
    ...
    name: 'Vision des ombres',
    pathId: 'prestige-ombres',
    rank: 4,
    isSpell: false,
    actionTypes: [],
    text:
  ...
  // ===== Voie du chasseur de prime (p. 140) =====
  {
    ...
    pathId: 'prestige-chasseur-de-prime',
    rank: 4,
    isSpell: false,
    actionTypes: ['L'],
    text:
  ...
  // ===== Voie du héros (p. 142) =====
  {
    ...
    name: 'Destin héroïque',
    pathId: 'prestige-heros',
    rank: 4,
    isSpell: false,
    actionTypes: [],
    text:
  ...
  },
  {
    ...
    name: 'Homme/femme de la situation',
    pathId: 'prestige-heros',
    rank: 5,
    isSpell: false,
    actionTypes: [],
  ...
  // ===== Voie du maître des poisons (p. 143) =====
  {
    ...
    name: 'Connaissance du poison',
    pathId: 'prestige-maitre-des-poisons',
    rank: 4,
    isSpell: false,
    actionTypes: [],
    text:
  ...
  // ===== Voie du pacte féérique (p. 143) =====
  {
    ...
    pathId: 'prestige-pacte-feerique',
    rank: 4,
    isSpell: false,
    actionTypes: ['L'],
    text:
  ...
  // ===== Voie du touche à tout (p. 144) =====
  {
    ...
    name: "Domaine de l'aventure",
    pathId: 'prestige-touche-a-tout',
    rank: 4,
    isSpell: false,
    actionTypes: [],
    text:
