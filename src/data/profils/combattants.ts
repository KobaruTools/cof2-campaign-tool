...
export const profilsCombattants: Profil[] = [
  {
    id: 'barbare',
    nom: 'Barbare',
    familleId: 'combattants',
    description:
    ...
    equipementDepart: [
      {
        itemId: null,
        libelle: 'Hache à deux mains (DM 2d6) ou Arme à une main (d8) et bouclier (+2 en DEF)',
        quantite: 1,
      },
      { itemId: 'javelot', libelle: 'javelots (DM 1d6, portée 20 m)', quantite: 2 },
  ...
  },
  {
    ...
    armureMaxId: 'armure-de-plaques',
    bouclierAutorise: true,
    equipementDepart: [
      { itemId: 'epee-longue', libelle: 'Épée longue (DM 1d8)', quantite: 1 },
      { itemId: 'grand-bouclier', libelle: 'grand bouclier (DEF +2)', quantite: 1 },
      { itemId: 'lance-de-cavalerie', libelle: 'lance de cavalerie (DM 2d6)', quantite: 1 },
      { itemId: 'dague', libelle: 'dague (DM 1d4)', quantite: 1 },
  ...
  },
  {
    ...
    armureMaxId: 'cotte-de-mailles',
    bouclierAutorise: true,
    equipementDepart: [
      { itemId: 'epee-longue', libelle: 'Épée longue (DM 1d8)', quantite: 1 },
      { itemId: null, libelle: 'épée ou hache à deux mains (DM 2d6)', quantite: 1 },
      { itemId: null, libelle: 'une dague ou une hachette de lancer', quantite: 1 },
      { itemId: 'grand-bouclier', libelle: 'un grand bouclier (DEF +2)', quantite: 1 },
...
export const voiesCombattants: VoieDeProfil[] = [
  // -- Barbare ---------------------------------------------------------------
  {
    type: 'profil',
    id: 'brute',
    ...
    profilIds: ['barbare'],
    capaciteIds: ['brute-r1', 'brute-r2', 'brute-r3', 'brute-r4', 'brute-r5'],
    sourcePage: 79,
  },
  {
    type: 'profil',
    ...
    nom: 'Voie du pagne',
    profilIds: ['barbare'],
    capaciteIds: ['pagne-r1', 'pagne-r2', 'pagne-r3', 'pagne-r4', 'pagne-r5'],
    sourcePage: 80,
  },
  {
    type: 'profil',
  ...
  },
  {
    ...
    profilIds: ['barbare'],
    capaciteIds: ['primitif-r1', 'primitif-r2', 'primitif-r3', 'primitif-r4', 'primitif-r5'],
    sourcePage: 81,
  },
  {
    type: 'profil',
    ...
    nom: 'Voie de la rage',
    profilIds: ['barbare'],
    capaciteIds: ['rage-r1', 'rage-r2', 'rage-r3', 'rage-r4', 'rage-r5'],
  ...
  // -- Chevalier -------------------------------------------------------------
  {
    ...
    profilIds: ['chevalier'],
    capaciteIds: ['cavalier-r1', 'cavalier-r2', 'cavalier-r3', 'cavalier-r4', 'cavalier-r5'],
  ...
  },
  {
    ...
    profilIds: ['chevalier'],
    capaciteIds: ['guerre-r1', 'guerre-r2', 'guerre-r3', 'guerre-r4', 'guerre-r5'],
    sourcePage: 84,
  },
  {
    type: 'profil',
    ...
    nom: 'Voie du preux',
    profilIds: ['chevalier'],
    capaciteIds: ['preux-r1', 'preux-r2', 'preux-r3', 'preux-r4', 'preux-r5'],
    sourcePage: 85,
  },
  {
    type: 'profil',
  ...
  },
  {
    ...
    profilIds: ['chevalier'],
    capaciteIds: ['noblesse-r1', 'noblesse-r2', 'noblesse-r3', 'noblesse-r4', 'noblesse-r5'],
    sourcePage: 86,
  },
  ...
  // -- Guerrier ---------------------------------------------------------------
  {
    ...
    profilIds: ['guerrier'],
    capaciteIds: ['bouclier-r1', 'bouclier-r2', 'bouclier-r3', 'bouclier-r4', 'bouclier-r5'],
  ...
  },
  {
    ...
    nom: 'Voie du combat',
    profilIds: ['guerrier'],
    capaciteIds: ['combat-r1', 'combat-r2', 'combat-r3', 'combat-r4', 'combat-r5'],
  ...
  },
  {
    ...
    nom: 'Voie du soldat',
    profilIds: ['guerrier'],
    capaciteIds: ['soldat-r1', 'soldat-r2', 'soldat-r3', 'soldat-r4', 'soldat-r5'],
    sourcePage: 90,
  },
];
...
export const capacitesCombattants: Capacite[] = [
  ...
  },
  {
    ...
    estSort: false,
    typesAction: [],
    texte: 'Le barbare augmente sa FOR de +1. Désormais, il obtient un dé bonus aux tests de FOR.',
    sourcePage: 80,
  },
  {
    id: 'brute-r5',
  ...
  },
  {
    ...
    estSort: false,
    typesAction: [],
    texte: 'Le guerrier obtient un dé bonus lorsqu’il exécute une manœuvre en combat.',
    sourcePage: 88,
  },
  {
    id: 'combat-r3',
  ...
  },
  {
    ...
    estSort: false,
    typesAction: ['L'],
    texte: 'Le guerrier fait deux attaques au contact durant son tour avec un malus de -2.',
    sourcePage: 88,
  },
  {
    id: 'combat-r5',
