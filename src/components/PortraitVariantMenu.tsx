...
export interface PortraitVariantMenuProps {
  ...
  /** Fichier choisi par l'utilisateur — validation/envoi/mise en attente restent à l'appelant. */
 ...
 * réseau : le fichier choisi remonte tel quel via `onSelectFile`, à l'appelant
 * de décider s'il l'envoie immédiatement (fiche) ou le met en attente
 * (wizard, tant que le personnage n'existe pas encore en DB). Réutilisé
 * identique par la fiche et l'étape « Identité » du wizard de création.
 */
