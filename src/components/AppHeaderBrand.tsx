...
/**
 * Icône « tête de dragon » (game-icons.net, `lorc/dragon-head.svg`, CC BY 3.0 —
 * voir NOTICE.md). Sert de logo de marque de l'application. Volontairement distincte
 * de `QuestIcon` (parchemin = Campagnes) et de l'icône livre du Bestiaire (`MenuBook`),
 * pour rester lisible dans le cluster de gauche de l'en-tête. Le markup est nettoyé
 * (fond retiré, `fill` neutralisé en `currentColor`) comme les autres icônes vendues.
 */
