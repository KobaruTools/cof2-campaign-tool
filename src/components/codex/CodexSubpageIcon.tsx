 ...
 *  - Familiers & montures → `SectionIcon` « companions » (tête de loup) : même icône que le
 *    bouton Bestiaire de l'en-tête — assumé (thème juste, la seule icône « animal » du jeu
 *    d'assets), tranché avec le propriétaire malgré la réutilisation.
