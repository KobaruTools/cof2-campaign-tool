...
export type DefenseBadgeIconKey = "situational-immunity";
...
export const DEFENSE_BADGE_ICON_SOURCES: Record<DefenseBadgeIconKey, string> = {
  "situational-immunity": "lorc/daemon-skull.svg",
};
